...
include::{snippets}/configuration-controller-test/get-config-by-user/curl-request.adoc[]

include::../../util/H-RESPONSE.adoc[]

include::../../util/H-RESPONSE-FIELDS.adoc[]

include::{snippets}/configuration-controller-test/get-config-by-user/response-fields.adoc[]

include::../../util/H-EXAMPLE-BARE.adoc[]

include::{snippets}/configuration-controller-test/get-config-by-user/http-response.adoc[]