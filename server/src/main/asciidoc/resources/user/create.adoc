...
include::{snippets}/rest-user-controller-test/register/request-fields.adoc[]

include::../../util/H-EXAMPLE.adoc[]

include::{snippets}/rest-user-controller-test/register/curl-request.adoc[]

include::../../util/H-RESPONSE.adoc[]

include::../../util/H-EXAMPLE-BARE.adoc[]

include::{snippets}/rest-user-controller-test/register/http-response.adoc[]
...
include::{snippets}/security-controller-test/sign-up-user-o-k/request-fields.adoc[]

include::../../util/H-EXAMPLE.adoc[]

include::{snippets}/security-controller-test/sign-up-user-o-k/curl-request.adoc[]

*Response*

include::../../util/H-EXAMPLE-BARE.adoc[]

include::{snippets}/security-controller-test/sign-up-user-o-k/http-response.adoc[]