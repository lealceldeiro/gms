...
include::{snippets}/role-controller-test/update-permissions-from-role/curl-request.adoc[]
...
include::{snippets}/role-controller-test/update-permissions-from-role/http-response.adoc[]