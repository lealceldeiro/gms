...
include::{snippets}/b-role-repository-test/create-role/request-fields.adoc[]

include::../../util/H-EXAMPLE.adoc[]

include::{snippets}/b-role-repository-test/create-role/curl-request.adoc[]

include::../../util/H-RESPONSE.adoc[]

include::../../util/H-EXAMPLE-BARE.adoc[]

include::{snippets}/b-role-repository-test/create-role/http-response.adoc[]