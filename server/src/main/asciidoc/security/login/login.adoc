...
include::{snippets}/security-config-test/login-o-k/request-fields.adoc[]

*Example request (successful)*

include::{snippets}/security-config-test/login-o-k/curl-request.adoc[]

*Example response for a successful authentication*

include::{snippets}/security-config-test/login-o-k/http-response.adoc[]
...
include::{snippets}/b-permission-repository-test/list-permissions/curl-request.adoc[]
